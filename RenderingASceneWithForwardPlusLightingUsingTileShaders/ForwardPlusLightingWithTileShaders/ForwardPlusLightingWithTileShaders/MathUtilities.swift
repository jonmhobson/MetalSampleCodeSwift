...
extension simd_float4x4 {
    ...
    static func perspectiveLeftHand(fovyRadians: Float, aspect: Float, nearZ: Float, farZ: Float) -> simd_float4x4 {
        let ys = 1.0 / tanf(fovyRadians * 0.5)
        let xs = ys / aspect
    ...
    var upperLeft: simd_float3x3 {
        return simd_float3x3([self.columns.0.x, self.columns.0.y, self.columns.0.z],
